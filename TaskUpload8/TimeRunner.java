...
public class TimeRunner 
{
	...
	private void exercise1(Scanner scanner, TimeTasks timeObj) throws InvalidException
	{
		...
		logger.info(timeObj.getCurrentTime(pattern));
	}
	
	private void exercise2(Scanner scanner, TimeTasks timeObj)
	{
		logger.info("CurrentTime in Millis using java.time package : "+timeObj.getCurrentTimeInMilliUsingTimePackage());
		logger.info("CurrentTime in Millis using System package : "+timeObj.getCurrentTimeInMilliUsingSystem());
	}
	...
	private void exercise3(Scanner scanner, TimeTasks timeObj) throws InvalidException
	{
		...
		logger.info("Current Time at zone : "+zone1+" is = "+timeObj.getCurrentTimeFromZones(zone1, pattern));
		//logger.info();
		logger.info("Current Time at zone : "+zone2+" is = "+timeObj.getCurrentTimeFromZones(zone2, pattern));
	}
	...
	private void exercise4(Scanner scanner, TimeTasks timeObj)
	{
		...
		logger.info("The day of the week for the given millis : "+ timeObj.getCurrentDayOfWeekFromMillis(millis));
	}
	...
	private void exercise5(Scanner scanner, TimeTasks timeObj)
	{
		...
		logger.info("The day of the week for the given millis : "+ timeObj.getCurrentMonthFromMillis(millis));
	}
	...
	private void exercise6(Scanner scanner, TimeTasks timeObj)
	{
		...
		logger.info("The day of the week for the given millis : "+ timeObj.getCurrentYearFromMillis(millis));
	}
}
